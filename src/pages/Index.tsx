...
const Index = () => {
  ...
  const quickStats = [
    { label: "Cotações", value: stats?.quotationsCount || 0, icon: FileText },
    { label: "Contratos", value: stats?.contractsCount || 0, icon: FileSignature },
    { label: "Modelos", value: stats?.modelsCount || 0, icon: Ship },
    { label: "Usuários", value: stats?.usersCount || 0, icon: Users },
  ];
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Sistema CPQ</p>
              </div>
            </div>
            {user && <UserMenu />}
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {navigationCards.map((item) => {
                ...
                return (
                  <Card
                    key={item.path}
                    className="bg-background hover:shadow-lg hover:border-primary/30 transition-all duration-200 cursor-pointer border group"
