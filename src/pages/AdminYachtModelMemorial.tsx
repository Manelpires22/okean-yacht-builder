...
import { Plus, Edit2, Trash, ArrowLeft, FileText } from "lucide-react";
...
export default function AdminYachtModelMemorial() {
  ...
  const { data: model, isLoading: loadingModel } = useQuery({
  ...
  const { data: items, isLoading: loadingItems, deleteItem } = useMemorialItems(modelId);
      ...
      <div className="space-y-6">
        <div>
          ...
          <div className="flex justify-between items-start">
            <div>
              <h1 className="text-3xl font-bold">Memorial Descritivo</h1>
