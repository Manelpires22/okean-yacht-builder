...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const memorialItems = [
      ...
      { category: 'deck_externo', display_order: 1, item_name: 'Acesso a plataforma de popa', description: 'Por degraus de fibra de vidro', brand: null, model: null, quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 2, item_name: 'Escada de acesso praça de máquinas', description: 'Com degraus de teca', brand: 'Aço inox', model: null, quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 3, item_name: 'Degraus de acesso ao flybridge', description: null, brand: 'Aço inox', model: null, quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 4, item_name: 'Paióis de armazenamento', description: 'Abaixo dos bancos de cockpit', brand: null, model: null, quantity: 2, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 5, item_name: 'Paióis de armazenamento', description: 'Na proa', brand: null, model: null, quantity: 2, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 6, item_name: 'Escotilhas', description: 'Para acesso a porão na proa', brand: null, model: null, quantity: 2, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 7, item_name: 'Ganchos de amarração', description: null, brand: 'Aço inox', model: null, quantity: 6, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 8, item_name: 'Cabos de amarração', description: null, brand: null, model: null, quantity: 4, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 9, item_name: 'Mangueira de água de abastecimento', description: null, brand: null, model: null, quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 10, item_name: 'Âncora estilo Bruce', description: 'Com 75m de corrente 8mm', brand: null, model: '20kg', quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 11, item_name: 'Guinchos de âncora', description: null, brand: null, model: null, quantity: 2, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 12, item_name: 'Guindaste para tender', description: null, brand: null, model: null, quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 13, item_name: 'Tender', description: null, brand: null, model: '310cm', quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 14, item_name: 'Motor de popa para tender', description: null, brand: null, model: '6HP', quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 15, item_name: 'Defensas cilíndricas', description: null, brand: null, model: null, quantity: 6, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 16, item_name: 'Defensas esféricas', description: null, brand: null, model: null, quantity: 2, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 17, item_name: 'Chuveiro de água quente e fria', description: 'Na plataforma de popa', brand: null, model: null, quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 18, item_name: 'Porta água e energia de cais', description: null, brand: 'Aço inox', model: null, quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 19, item_name: 'Cabo de conexão de cais', description: null, brand: null, model: '230V, 15 metros', quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 20, item_name: 'Escada de banho', description: null, brand: 'Aço inox', model: null, quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 21, item_name: 'Plataforma de popa', description: 'Eletro-hidráulica dobrável', brand: null, model: null, quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 22, item_name: 'Pega mão de popa com cunhos', description: null, brand: 'Aço inox', model: null, quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 23, item_name: 'Corrimão', description: null, brand: 'Aço inox', model: null, quantity: 1, unit: 'conjunto', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 24, item_name: 'Piso de teca', description: 'Em todo deck principal', brand: null, model: null, quantity: 1, unit: 'm²', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 25, item_name: 'Puxador porta casa de máquinas', description: 'Para desligamento emergencial dos motores', brand: null, model: null, quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 26, item_name: 'Sofá de popa', description: 'Com almofadas e colchões', brand: null, model: null, quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 27, item_name: 'Mesa em fibra de vidro com tampo de madeira', description: null, brand: null, model: null, quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 28, item_name: 'Banco em fibra de vidro com assento de madeira', description: null, brand: null, model: null, quantity: 2, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 29, item_name: 'Luzes de cortesia de deck', description: null, brand: null, model: null, quantity: 1, unit: 'conjunto', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 30, item_name: 'Alto-falantes à prova d\'água', description: 'No cockpit', brand: null, model: null, quantity: 2, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 31, item_name: 'Limpador de para-brisa', description: null, brand: null, model: null, quantity: 2, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 32, item_name: 'Pia', description: 'Com água quente e fria', brand: 'Aço inox', model: null, quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 33, item_name: 'Vigia', description: 'No cockpit', brand: null, model: null, quantity: 2, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'deck_externo', display_order: 34, item_name: 'Porta de acesso', description: 'De fibra de vidro e vidro temperado', brand: null, model: null, quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      ...
      { category: 'corredor_inferior', display_order: 1, item_name: 'Iluminação de cortesia no teto', description: null, brand: null, model: null, quantity: 1, unit: 'conjunto', is_customizable: true, is_active: true },
      { category: 'corredor_inferior', display_order: 2, item_name: 'Piso vinílico', description: 'Imitação madeira', brand: null, model: null, quantity: 1, unit: 'm²', is_customizable: true, is_active: true },
      { category: 'corredor_inferior', display_order: 3, item_name: 'Tomadas 110V e 220V', description: null, brand: null, model: null, quantity: 2, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'corredor_inferior', display_order: 4, item_name: 'Vigia', description: null, brand: null, model: null, quantity: 2, unit: 'unidade', is_customizable: true, is_active: true },
      ...
      // ===== CABINE MARINHEIRO (7 itens) =====
      { category: 'cabine_marinheiro', display_order: 1, item_name: 'Beliche', description: null, brand: null, model: null, quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'cabine_marinheiro', display_order: 2, item_name: 'Armário', description: null, brand: null, model: null, quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'cabine_marinheiro', display_order: 3, item_name: 'Iluminação de teto', description: null, brand: null, model: null, quantity: 1, unit: 'conjunto', is_customizable: true, is_active: true },
      { category: 'cabine_marinheiro', display_order: 4, item_name: 'Luminárias de leitura', description: null, brand: null, model: null, quantity: 2, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'cabine_marinheiro', display_order: 5, item_name: 'Tomadas 110V e 220V', description: null, brand: null, model: null, quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'cabine_marinheiro', display_order: 6, item_name: 'Piso vinílico', description: 'Imitação madeira', brand: null, model: null, quantity: 1, unit: 'm²', is_customizable: true, is_active: true },
      { category: 'cabine_marinheiro', display_order: 7, item_name: 'Painel de controle de ar condicionado', description: null, brand: null, model: null, quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      ...
      { category: 'propulsao', display_order: 1, item_name: 'Sistema de direção hidráulica', description: null, brand: null, model: null, quantity: 1, unit: 'sistema', is_customizable: true, is_active: true },
      { category: 'propulsao', display_order: 2, item_name: 'Bow thruster', description: 'Hidráulico', brand: null, model: '20HP', quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'propulsao', display_order: 3, item_name: 'Trim tabs', description: 'Com controle no comando principal e flybridge', brand: null, model: null, quantity: 1, unit: 'conjunto', is_customizable: true, is_active: true },
      { category: 'propulsao', display_order: 4, item_name: 'Estabilizadores hidráulicos', description: null, brand: null, model: null, quantity: 2, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'propulsao', display_order: 5, item_name: 'Sistema de combustível', description: 'Com filtros e bombas', brand: null, model: null, quantity: 1, unit: 'sistema', is_customizable: true, is_active: true },
      { category: 'propulsao', display_order: 6, item_name: 'Sistema de resfriamento', description: 'Com trocadores de calor', brand: null, model: null, quantity: 1, unit: 'sistema', is_customizable: true, is_active: true },
      { category: 'propulsao', display_order: 7, item_name: 'Sistema de lubrificação', description: null, brand: null, model: null, quantity: 1, unit: 'sistema', is_customizable: true, is_active: true },
      ...
      // ===== COMUNICAÇÃO (2 itens) =====
      { category: 'comunicacao', display_order: 1, item_name: 'Antena de rádio VHF', description: null, brand: null, model: null, quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'comunicacao', display_order: 2, item_name: 'Sistema de interfone', description: 'Entre comando e praça de máquinas', brand: null, model: null, quantity: 1, unit: 'sistema', is_customizable: true, is_active: true },

      // ===== NAVEGAÇÃO (3 itens) =====
      { category: 'navegacao', display_order: 1, item_name: 'Transdutor de profundidade', description: null, brand: null, model: null, quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'navegacao', display_order: 2, item_name: 'Transdutor de velocidade', description: null, brand: null, model: null, quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'navegacao', display_order: 3, item_name: 'Sensor de vento', description: null, brand: null, model: null, quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },

      // ===== SISTEMA DE ÁGUA DE PORÃO (3 itens) =====
      { category: 'agua_porao', display_order: 1, item_name: 'Bombas de água de porão', description: 'Automáticas', brand: null, model: null, quantity: 3, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'agua_porao', display_order: 2, item_name: 'Bomba de água de porão', description: 'Manual', brand: null, model: null, quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'agua_porao', display_order: 3, item_name: 'Alarme de nível de água de porão', description: null, brand: null, model: null, quantity: 1, unit: 'sistema', is_customizable: true, is_active: true },

      // ===== SISTEMA SANITÁRIO (13 itens) =====
      { category: 'sanitario', display_order: 1, item_name: 'Tanques de águas cinzas', description: null, brand: null, model: null, quantity: 2, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'sanitario', display_order: 2, item_name: 'Tanques de águas negras', description: null, brand: null, model: null, quantity: 2, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'sanitario', display_order: 3, item_name: 'Bombas de transferência de águas cinzas', description: null, brand: null, model: null, quantity: 2, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'sanitario', display_order: 4, item_name: 'Bombas de transferência de águas negras', description: null, brand: null, model: null, quantity: 2, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'sanitario', display_order: 5, item_name: 'Deck fill de água cinza', description: null, brand: 'Aço inox', model: null, quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'sanitario', display_order: 6, item_name: 'Deck fill de água negra', description: null, brand: 'Aço inox', model: null, quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'sanitario', display_order: 7, item_name: 'Sistema de distribuição de água doce', description: 'Com bomba pressurizada', brand: null, model: null, quantity: 1, unit: 'sistema', is_customizable: true, is_active: true },
      { category: 'sanitario', display_order: 8, item_name: 'Sistema de água quente', description: 'Circulação em anel', brand: null, model: null, quantity: 1, unit: 'sistema', is_customizable: true, is_active: true },
      { category: 'sanitario', display_order: 9, item_name: 'Filtro de água', description: 'Para água potável', brand: null, model: null, quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'sanitario', display_order: 10, item_name: 'Sistema de descarga elétrica', description: 'Para vasos sanitários', brand: null, model: null, quantity: 1, unit: 'sistema', is_customizable: true, is_active: true },
      { category: 'sanitario', display_order: 11, item_name: 'Válvula de limpeza de tanques', description: null, brand: null, model: null, quantity: 4, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'sanitario', display_order: 12, item_name: 'Mangueira de esgotamento', description: null, brand: null, model: null, quantity: 1, unit: 'unidade', is_customizable: true, is_active: true },
      { category: 'sanitario', display_order: 13, item_name: 'Sistema de exaustão de banheiros', description: null, brand: null, model: null, quantity: 1, unit: 'sistema', is_customizable: true, is_active: true },
      ...
      { category: 'navegacao', display_order: 100, item_name: '[OPCIONAL] Upgrade telas Simrad', description: 'Telas maiores de navegação', brand: 'Simrad', model: null, quantity: 1, unit: 'upgrade', is_customizable: false, is_active: true },
      ...
      { category: 'deck_externo', display_order: 100, item_name: '[OPCIONAL] Plataforma submergível com guindaste de proa', description: 'Para embarque e desembarque facilitado', brand: null, model: null, quantity: 1, unit: 'unidade', is_customizable: false, is_active: true },
      { category: 'acabamentos_interiores', display_order: 1, item_name: '[OPCIONAL] Piso vinílico imitação madeira Amtico', description: 'Upgrade de piso premium', brand: 'Amtico', model: null, quantity: 1, unit: 'm²', is_customizable: false, is_active: true },
      { category: 'propulsao', display_order: 100, item_name: '[OPCIONAL] Estabilizador de cruzeiro Seekeeper', description: 'Sistema giroscópico de estabilização', brand: 'Seekeeper', model: '6', quantity: 1, unit: 'unidade', is_customizable: false, is_active: true },
      { category: 'deck_externo', display_order: 101, item_name: '[OPCIONAL] Passarela telescópica de fibra de carbono', description: 'Com controle remoto', brand: null, model: null, quantity: 1, unit: 'unidade', is_customizable: false, is_active: true },
      ...
      { category: 'acabamentos_interiores', display_order: 2, item_name: '[OPCIONAL] Revestimento Calacata no WC master', description: 'Mármore premium', brand: null, model: null, quantity: 1, unit: 'm²', is_customizable: false, is_active: true },
      { category: 'acabamentos_interiores', display_order: 3, item_name: '[OPCIONAL] Revestimento Calacata no WC VIP', description: 'Mármore premium', brand: null, model: null, quantity: 1, unit: 'm²', is_customizable: false, is_active: true },
      { category: 'acabamentos_interiores', display_order: 4, item_name: '[OPCIONAL] Revestimento Calacata no WC hóspedes', description: 'Mármore premium', brand: null, model: null, quantity: 1, unit: 'm²', is_customizable: false, is_active: true },
      ...
      { category: 'deck_externo', display_order: 102, item_name: '[OPCIONAL] 04 cadeiras dobráveis com suporte no cockpit', description: null, brand: null, model: null, quantity: 4, unit: 'unidade', is_customizable: false, is_active: true },
      { category: 'acabamentos_exteriores', display_order: 1, item_name: '[OPCIONAL] Pintura de fundo anti-fouling', description: 'Proteção contra incrustações', brand: null, model: null, quantity: 1, unit: 'aplicação', is_customizable: false, is_active: true },
      { category: 'deck_externo', display_order: 103, item_name: '[OPCIONAL] Porta-copos de teca', description: 'Para sofá de popa', brand: null, model: null, quantity: 4, unit: 'unidade', is_customizable: false, is_active: true },
      ...
      { category: 'comunicacao', display_order: 100, item_name: '[OPCIONAL] Antena internet 3G/4G', description: null, brand: null, model: null, quantity: 1, unit: 'unidade', is_customizable: false, is_active: true },
      ...
      { category: 'deck_externo', display_order: 104, item_name: '[OPCIONAL] Fechamento de popa em lona', description: 'Com estrutura', brand: null, model: null, quantity: 1, unit: 'conjunto', is_customizable: false, is_active: true },
      ...
      { category: 'cabine_marinheiro', display_order: 100, item_name: '[OPCIONAL] Máquina lava e seca de roupas', description: null, brand: null, model: null, quantity: 1, unit: 'unidade', is_customizable: false, is_active: true },
      { category: 'cabine_marinheiro', display_order: 101, item_name: '[OPCIONAL] Freezer extra', description: null, brand: null, model: null, quantity: 1, unit: 'unidade', is_customizable: false, is_active: true },
    ];
