...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const memorialItems = [
      ...
      // ===== CASA DE MÁQUINAS (25 itens) =====
      { category: 'casa_de_maquinas', display_order: 1, item_name: 'Motores MAN V12 1550HP', description: 'Diesel common rail', brand: 'MAN', model: 'V12-1550', quantity: 2, unit: 'unidade' },
      { category: 'casa_de_maquinas', display_order: 2, item_name: 'Geradores diesel', description: '27,5kW/60Hz', brand: 'Kohler', model: null, quantity: 2, unit: 'unidade' },
      { category: 'casa_de_maquinas', display_order: 3, item_name: 'Trim tabs hidráulicos', description: null, brand: null, model: null, quantity: 1, unit: 'conjunto' },
      { category: 'casa_de_maquinas', display_order: 4, item_name: 'Estabilizadores giroscópicos', description: null, brand: 'Seakeeper', model: '35', quantity: 1, unit: 'unidade' },
      { category: 'casa_de_maquinas', display_order: 5, item_name: 'Central hidráulica', description: 'Para bow thruster e plataforma', brand: null, model: null, quantity: 1, unit: 'unidade' },
      { category: 'casa_de_maquinas', display_order: 6, item_name: 'Tanque de combustível', description: 'Em aço inox 5600L', brand: null, model: null, quantity: 1, unit: 'unidade' },
      { category: 'casa_de_maquinas', display_order: 7, item_name: 'Tanque de água potável', description: 'Em aço inox 1200L', brand: null, model: null, quantity: 1, unit: 'unidade' },
      { category: 'casa_de_maquinas', display_order: 8, item_name: 'Tanque de esgoto', description: '400L', brand: null, model: null, quantity: 1, unit: 'unidade' },
      { category: 'casa_de_maquinas', display_order: 9, item_name: 'Bombas de porão automáticas', description: 'Com alarme', brand: null, model: null, quantity: 3, unit: 'unidade' },
      { category: 'casa_de_maquinas', display_order: 10, item_name: 'Bombas de água doce', description: 'Pressurizadas', brand: null, model: null, quantity: 2, unit: 'unidade' },
      { category: 'casa_de_maquinas', display_order: 11, item_name: 'Bomba de transferência de combustível', description: null, brand: null, model: null, quantity: 1, unit: 'unidade' },
      { category: 'casa_de_maquinas', display_order: 12, item_name: 'Sistema de tratamento de esgoto', description: null, brand: null, model: null, quantity: 1, unit: 'unidade' },
      { category: 'casa_de_maquinas', display_order: 13, item_name: 'Watermaker (dessalinizador)', description: '180L/h', brand: null, model: null, quantity: 1, unit: 'unidade' },
      { category: 'casa_de_maquinas', display_order: 14, item_name: 'Sistema de resfriamento dos motores', description: null, brand: null, model: null, quantity: 1, unit: 'sistema' },
      { category: 'casa_de_maquinas', display_order: 15, item_name: 'Sistema de extinção de incêndio automático', description: 'FM200', brand: null, model: null, quantity: 1, unit: 'sistema' },
      { category: 'casa_de_maquinas', display_order: 16, item_name: 'Ventilação forçada', description: 'Exaustores e ventiladores', brand: null, model: null, quantity: 1, unit: 'sistema' },
      { category: 'casa_de_maquinas', display_order: 17, item_name: 'Isolamento acústico', description: null, brand: null, model: null, quantity: 1, unit: 'sistema' },
      { category: 'casa_de_maquinas', display_order: 18, item_name: 'Painel de monitoramento', description: 'Para motores e geradores', brand: null, model: null, quantity: 1, unit: 'unidade' },
      { category: 'casa_de_maquinas', display_order: 19, item_name: 'Iluminação de emergência', description: null, brand: null, model: null, quantity: 1, unit: 'conjunto' },
      { category: 'casa_de_maquinas', display_order: 20, item_name: 'Separador de água e óleo', description: null, brand: null, model: null, quantity: 1, unit: 'unidade' },
      { category: 'casa_de_maquinas', display_order: 21, item_name: 'Filtros de combustível', description: 'Decantadores Racor', brand: 'Racor', model: null, quantity: 4, unit: 'unidade' },
      { category: 'casa_de_maquinas', display_order: 22, item_name: 'Aquecedor de água elétrico', description: '100L', brand: null, model: null, quantity: 2, unit: 'unidade' },
      { category: 'casa_de_maquinas', display_order: 23, item_name: 'Compressor de ar', description: 'Para manutenção', brand: null, model: null, quantity: 1, unit: 'unidade' },
      { category: 'casa_de_maquinas', display_order: 24, item_name: 'Sistema de drenagem', description: null, brand: null, model: null, quantity: 1, unit: 'sistema' },
      { category: 'casa_de_maquinas', display_order: 25, item_name: 'Kit de ferramentas e peças sobressalentes', description: null, brand: null, model: null, quantity: 1, unit: 'conjunto' },
      ...
      { category: 'tender_brinquedos', display_order: 1, item_name: 'Tender inflável Williams 445', description: 'Com motor Mercury 100HP', brand: 'Williams', model: 'Sportjet 445', quantity: 1, unit: 'unidade' },
      { category: 'tender_brinquedos', display_order: 2, item_name: 'Jet ski Sea-Doo', description: 'GTX 300', brand: 'Sea-Doo', model: 'GTX 300', quantity: 1, unit: 'unidade', is_customizable: true },
      { category: 'tender_brinquedos', display_order: 3, item_name: 'Pranchas de stand-up paddle', description: null, brand: null, model: null, quantity: 2, unit: 'unidade', is_customizable: true },
      { category: 'tender_brinquedos', display_order: 4, item_name: 'Caiaques duplos', description: null, brand: null, model: null, quantity: 1, unit: 'unidade', is_customizable: true },
      { category: 'tender_brinquedos', display_order: 5, item_name: 'Equipamento de mergulho', description: 'Máscaras, nadadeiras e snorkel', brand: null, model: null, quantity: 6, unit: 'conjunto', is_customizable: true },
      { category: 'tender_brinquedos', display_order: 6, item_name: 'Boia rebocável', description: 'Para 3 pessoas', brand: null, model: null, quantity: 1, unit: 'unidade', is_customizable: true },
      { category: 'tender_brinquedos', display_order: 7, item_name: 'Wakeboard e esqui aquático', description: null, brand: null, model: null, quantity: 1, unit: 'conjunto', is_customizable: true },
      { category: 'tender_brinquedos', display_order: 8, item_name: 'Seabob underwater scooter', description: null, brand: 'Seabob', model: 'F5 SR', quantity: 1, unit: 'unidade', is_customizable: true },

      // ===== CONFORTO TÉRMICO (12 itens) =====
      { category: 'conforto_termico', display_order: 1, item_name: 'Sistema de ar-condicionado central', description: '120.000 BTU', brand: null, model: null, quantity: 1, unit: 'sistema' },
      { category: 'conforto_termico', display_order: 2, item_name: 'Unidades evaporadoras nas cabines', description: null, brand: null, model: null, quantity: 5, unit: 'unidade' },
      { category: 'conforto_termico', display_order: 3, item_name: 'Unidade evaporadora no salão', description: null, brand: null, model: null, quantity: 1, unit: 'unidade' },
      { category: 'conforto_termico', display_order: 4, item_name: 'Controles individuais de temperatura', description: null, brand: null, model: null, quantity: 7, unit: 'unidade' },
      { category: 'conforto_termico', display_order: 5, item_name: 'Aquecedor de água para chuveiros', description: null, brand: null, model: null, quantity: 2, unit: 'unidade' },
      { category: 'conforto_termico', display_order: 6, item_name: 'Piso aquecido nos banheiros', description: null, brand: null, model: null, quantity: 2, unit: 'sistema', is_customizable: true },
      { category: 'conforto_termico', display_order: 7, item_name: 'Ventiladores de teto', description: null, brand: null, model: null, quantity: 4, unit: 'unidade' },
      { category: 'conforto_termico', display_order: 8, item_name: 'Ventilação natural otimizada', description: null, brand: null, model: null, quantity: 1, unit: 'sistema' },
      { category: 'conforto_termico', display_order: 9, item_name: 'Isolamento térmico do casco', description: null, brand: null, model: null, quantity: 1, unit: 'sistema' },
      { category: 'conforto_termico', display_order: 10, item_name: 'Vidros temperados duplos', description: 'Com proteção UV', brand: null, model: null, quantity: 1, unit: 'conjunto' },
      { category: 'conforto_termico', display_order: 11, item_name: 'Cortinas térmicas', description: null, brand: null, model: null, quantity: 1, unit: 'conjunto' },
      { category: 'conforto_termico', display_order: 12, item_name: 'Sistema de desumidificação', description: null, brand: null, model: null, quantity: 1, unit: 'sistema' },
